                ...
                <div className='bg-slate-200 flex justify-center items-center rounded-xl'>
                    <div className="w-full max-w-md bg-[#ffffff] px-8 py-20 my-0 md:my-8 rounded-xl shadow-lg">
                        ...
                        <div className="flex flex-col gap-1 mb-4">
                            ...
                            <input type="text" name="username" id="username" placeholder="Type your username" className="w-full px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-1 text-black " />
                        </div>

                        <div className="flex flex-col gap-1 mb-1">
                            <label htmlFor="password">Password</label>
                            <input type="password" name="password" id="password" placeholder="Type your password" className="w-full px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-1 text-black " />
                        </div>
