        ...
        <>
            ...
            <div className={`flex flex-col gap-2 border border-stone-300 rounded-2xl p-6 mb-8 ${activePreview === "buttonPriview" ? 'block' : 'hidden'}`}>
                <div className='grid grid-cols-2 md:grid-cols-4 xxl:grid-cols-6 place-items-center gap-6'>
                    ...
                    <button className='relative text-xl text-white font-medium bg-[#EF1E7E] w-32 h-12 rounded-sm'>Normal</button>

                    <button className='relative text-xl text-[#EF1E7E] hover:text-white font-medium hover:bg-[#EF1E7E] w-32 h-12 border-2 border-[#EF1E7E] rounded-sm'>Hover Me</button>

                    <button className='relative text-xl text-[#EF1E7E] hover:text-white font-medium hover:bg-[#EF1E7E] w-32 h-12 border-2 border-[#EF1E7E] rounded-sm transition duration-500'>Hover Me</button>
                    ...
                    <button type='button' className='relative h-12 w-32 origin-left border-2 border-[#EF1E7E] text-xl text-[#EF1E7E] font-medium hover:text-white before:duration-700 before:absolute before:left-0 before:block before:w-0 hover:before:absolute hover:before:w-full hover:before:h-full hover:before:bg-[#EF1E7E]  hover:before:top-0 hover:before:-z-10'>HMe</button>

                    <button className='overflow-hidden group relative h-12 w-32 border-2 border-[#EF1E7E] text-xl text-[#EF1E7E] hover:text-white '><span className='bg-[#EF1E7E] absolute w-1/2 -translate-x-full group-hover:translate-x-0 left-0 top-0 bottom-0 duration-500 -z-10 '></span><span className='bg-[#000] absolute w-1/2 translate-x-full group-hover:translate-x-0 right-0 hover:-right-3 top-0 bottom-0 duration-500 -z-10 '></span>Hover Me</button>
