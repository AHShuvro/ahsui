    ...
    return (
        <>
            ...
            <div className='mt-8 md:mt-16 lg:mt-36 px-2 sm:px-4 md:px-11'>
                ...
                <h3 className='text-base md:text-lg lg:text-xl xl:text-2xl font-medium mb-8 '>Discover Treasure Trove: A World of <span className='text-[#EF1E7E]'>Free</span>, <span className='text-[#EF1E7E]'>Versatile</span>, <br />and <span className='text-[#EF1E7E]'>Customizable</span> Components Awaits Your Exploration.</h3>
                <div className='flex  gap-2'>
                    <Link to={'/components'}><button className='text-base md:text-lg lg:text-xl text-white font-medium bg-[#EF1E7E] hover:bg-[#D4156A] px-6 md:px-10 lg:px-16 py-2 lg:py-4 rounded-full '>Get Start</button></Link>
