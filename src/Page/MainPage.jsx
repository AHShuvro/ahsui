    ...
    return (
        <>  
            ...
            <div className='mt-36 pl-11'>
                ...
                <Link to={'/components'}><button className='text-xl text-white font-medium bg-[#EF1E7E] hover:bg-[#D4156A] px-16 py-4 rounded-full '>Get Start</button></Link>
                <Link to={'https://github.com/AHShuvro/ahsui'}><button className='text-xl text-black font-medium bg-gray-100 hover:bg-gray-300 px-16 py-4 rounded-full '>GitHub</button></Link>
                </div>
            </div>
        </>
    );
